...
BOT_SCRIPT = config.get('bot_script', 'bybit_bot_ST_STRICT.py')  # Updated to Bybit bot script
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Watchdog for Bybit Futures Trading Bot")
